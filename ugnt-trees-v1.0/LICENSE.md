...
The UGNT Trees are also heavily based on multiple Greek New Testament trees for internal use developed by [Global Bible Initiative, LLC](https://www.gbi.llc).
